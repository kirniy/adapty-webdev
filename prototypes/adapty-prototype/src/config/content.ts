...
view.present();`,
      testimonial: {
        logo: "/assets/cases/app-icon-fotorama.webp",
        quote:
          "Adapty turned our guesswork into science. We realized we were underpricing our yearly plan by 30%.",
        author: {
          name: "Alexey",
          role: "CEO, Fotorama",
          avatar: "/assets/cases/app-icon-fotorama.webp"
        }
      },
    },
    refundSaver: {
  ...
  if (user.ltv > 50) {
    ...
    await adapty.presentOffer({
      ...
      testimonial: {
        ...
        author: {
          name: "Maria",
          role: "Growth Manager, Moonly",
          avatar: "https://placehold.co/100x100/333/FFF/png?text=M"
        }
      },
    },
    subscriptionBI: {
