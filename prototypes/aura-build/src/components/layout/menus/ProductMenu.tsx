...
function MenuItem({ title, description, icon, href, badge }: MenuItemProps) {
  return (
    <Link
      href={href}
      className="flex items-start gap-3 p-3 rounded-xl hover:bg-stone-100 transition-colors group"
    >
...
export function ProductMenu() {
  return (
    <div className="w-[720px] p-6 grid grid-cols-3 gap-6">
      {/* TECH Column */}
      <div>
        <h4 className="text-xs font-semibold text-stone-400 uppercase tracking-wider mb-3 px-3">
          Tech
        </h4>
