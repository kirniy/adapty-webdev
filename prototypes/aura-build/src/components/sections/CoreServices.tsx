...
export function CoreServices() {
  ...
  return (
    <section ref={containerRef} id="services" className="lg:px-12 lg:mb-20 max-w-[1600px] mx-auto mb-12 px-6 relative">
      ...
      <h2 className="text-3xl lg:text-5xl font-medium text-stone-900 tracking-tight font-sans mb-10 lg:mb-12 text-balance animate-intro-blur animation-fill-mode-both relative z-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 auto-rows-fr relative">
        ...
        <motion.div 
            ...
            className="row-span-1 lg:row-span-2 group overflow-hidden lg:p-10 flex flex-col min-h-[500px] lg:min-h-full transition-transform hover:scale-[1.01] duration-300 bg-[#002f43] border-[#002f43] border rounded-[32px] pt-6 pr-6 pb-6 pl-6 relative justify-between z-10"
        >
        ...
        <motion.div 
            ...
            className="col-span-1 md:col-span-2 group overflow-hidden lg:p-10 min-h-[400px] flex flex-col md:flex-row transition-transform hover:scale-[1.01] duration-300 bg-lime-300 border-lime-300 border rounded-[32px] pt-6 pr-6 pb-6 pl-6 relative items-center justify-between z-10"
        >
        ...
        <motion.div 
            ...
            className="group relative overflow-hidden bg-lime-100/80 rounded-[32px] p-6 lg:p-10 flex flex-col justify-between min-h-[350px] transition-transform hover:scale-[1.01] duration-300 border border-lime-200 z-10"
        >
        ...
        <motion.div 
            ...
            className="group relative overflow-hidden bg-sky-50 rounded-[32px] p-6 lg:p-10 flex flex-col justify-between min-h-[350px] transition-transform hover:scale-[1.01] duration-300 border border-sky-100 z-10"
        >
