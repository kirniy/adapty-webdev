...
export const SOLUTION_ITEMS: MenuItem[] = [
  {
    ...
    description: 'Launch paywalls without coding'
  },
  {
    title: 'For Developers',
    href: '/for-developers',
    icon: '/images/menu-icons/icon-20x20-sdk.svg',
    description: 'Focus on code, not infrastructure'
  },
  {
    title: 'For App Owners',
    href: '/for-app-owners',
    icon: '/images/menu-icons/icon-24x24-4n.svg',
    description: 'Maximize subscription revenue'
  },
  {
  ...
  },
  {
    ...
    href: 'https://adapty.io/enterprise/',
    icon: '/images/menu-icons/icon-24x24-21n.svg',
    description: 'Scale with enterprise features',
    external: true
  }
];
...
export const COMPARE_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    href: '/compare',
    icon: '/images/menu-icons/icon-24x24-difference.svg',
    description: 'View all comparisons'
  }
];
...
export const INTEGRATIONS_ITEMS: MenuItem[] = [
  {
    ...
    description: 'Attribution & optimization'
  },
  {
    title: 'Amplitude',
    href: 'https://adapty.io/integrations/amplitude/',
    icon: '/images/menu-icons/icon-24x24-4n.svg',
  ...
  {
    title: 'Webhook',
    href: 'https://adapty.io/integrations/webhook/',
...
export const PRODUCT_SIDEBAR: MenuItem[] = PRODUCT_SIDEBAR_ITEMS.map(
  (item) => ({
    title: item.title,
    href: item.href
  })
...
export const PRODUCT_TABS: Record<
  'tech' | 'paywalls' | 'analytics',
  ProductTab
> = {
  tech: {
    label: 'Tech',
    items: [
      ...
      },
      {
        ...
        description: 'Sync data across all platforms',
        external: true
      },
      {
        ...
        description: 'Never lose a conversion'
      },
      {
        title: 'Refund saver',
        href: '/refund-saver',
        icon: '/images/menu-icons/icon-20x20-currency-exchange.svg',
        description: 'Reduce refunds automatically'
      }
    ]
  },
  paywalls: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Create converting onboardings'
      },
      {
        title: 'AI generator',
      ...
      },
      {
        ...
        description: 'Test and optimize paywalls'
      },
      {
        title: 'Autopilot',
        href: '/autopilot',
      ...
      },
      {
        ...
        description: 'Show right paywall to right user'
      },
      {
        title: 'Localizations',
        href: '/paywall-localization',
        icon: '/images/menu-icons/icon-24x24-10n.svg',
        description: 'Localize paywalls for any market'
      },
      {
        title: 'Remote config',
        href: '/remote-config',
        icon: '/images/menu-icons/icon-24x24-11n.svg',
        description: 'Update app behavior remotely'
      }
    ]
  },
  analytics: {
    ...
    items: [
      ...
      },
      {
        ...
        href: '/ltv-analytics',
        icon: '/images/menu-icons/icon-24x24-5n.svg',
        description: 'Understand user lifetime value'
      },
      {
      ...
      },
      {
        ...
        icon: '/images/menu-icons/icon-finance-blue-20dp-300w.svg',
        description: 'Connect ads to subscriptions',
        external: true
      }
    ]
  }
...
export const CASES_MENU: CaseStudy[] = [
  {
    ...
    metric: '+50%',
    description: 'revenue with Adapty Autopilot',
  ...
  },
  {
    name: 'Going Merry',
    metric: '5x',
    description: 'revenue growth using Paywall Builder',
  ...
  },
  {
    name: 'Fotorama',
    metric: '-40%',
    description: 'decreased refund rate with Adapty',
...
export const RESOURCES_SECTIONS: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        title: 'State of In-App Subscriptions',
...
export const LANGUAGES: Language[] = [
  {
    code: 'EN',
    label: 'English',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/en.svg',
    href: '/'
  },
  {
    code: 'TR',
    label: 'Turkce',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/tr.svg',
    href: '/tr/'
  },
  {
    code: 'DE',
    label: 'Deutsch',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/de.svg',
    href: '/de/'
  },
  {
    code: 'UA',
    label: 'Ukrainska',
    flag: 'https://adapty.io/assets/uploads/flags/ua.svg',
    href: '/ua/'
  },
  {
    code: 'PL',
    label: 'Polski',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/pl.svg',
    href: '/pl/'
  },
  {
    code: 'FR',
    label: 'Francais',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/fr.svg',
    href: '/fr/'
  },
  {
    code: 'RU',
    label: 'Russkiy',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/ru.svg',
    href: '/ru/'
  },
  {
    code: 'ES',
    label: 'Espanol',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/es.svg',
    href: '/es/'
  },
  {
    code: 'JA',
    label: 'Nihongo',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/ja.svg',
    href: '/ja/'
  },
  {
    code: 'KO',
    label: 'Hangugeo',
    flag: 'https://adapty.io/assets/plugins/sitepress-multilingual-cms/res/flags/ko.svg',
    href: '/ko/'
  },
  {
    code: 'ZH',
    label: 'Zhongwen',
    flag: 'https://adapty.io/assets/uploads/flags/flag-zh.svg',
    href: '/zh/'
  },
  {
    code: 'PT',
    label: 'Portugues',
    flag: 'https://adapty.io/assets/uploads/flags/flag-pt.svg',
    href: '/pt/'
  }
];
...
export const MOBILE_SUBMENU_DATA: Record<string, MobileSubmenuConfig> = {
  ...
  Docs: {
    ...
    sections: [
      ...
      {
        title: 'WEB PAYMENTS',
        items: [{ title: 'Stripe', href: 'https://adapty.io/docs/stripe/' }]
      },
      {
        title: 'WEB API',
        items: [
...
export const COMPACT_PRODUCT_LINKS: MenuItem[] = [
  ...
  },
  {
    ...
    href: '/paywall-builder',
    icon: '/images/menu-icons/icon-24x24-1n.svg',
    description: 'No-code paywall editor'
  },
  {
    title: 'A/B Testing',
    href: '/paywall-ab-testing',
  ...
  },
  {
    ...
    href: '/sdk',
    icon: '/images/menu-icons/icon-20x20-sdk.svg',
    description: 'In-app purchases SDK'
  },
  {
    title: 'Integrations',
    href: '/integrations',
...
export const COMPACT_CASES_LINKS: MenuItem[] = [
  {
    ...
    href: 'https://adapty.io/clients/going-merry/',
    icon: '/images/case-studies/going-merry.webp',
    description: '5x revenue growth'
  },
  {
    title: 'Shmoody',
    href: 'https://adapty.io/clients/shmoody/',
    icon: '/images/case-studies/shmoody.webp',
    description: '$0 to $2M ARR'
  },
  {
    title: 'Glam AI',
    href: 'https://adapty.io/clients/glam-ai/',
