...
export type OnboardingBuilderFeaturesVariant =
  | 'grid'
  | 'bento'
  | 'tabs'
  | 'off';
...
export const GRID_VARIANTS: VariantOption<GridVariant>[] = [
  {
    ...
    description: 'Classic diagonal static pattern'
  },
  {
    value: 'flickering',
    label: 'Flickering Grid',
    description: 'Animated pixel grid'
  },
  {
    value: 'cursor-tracking',
    label: 'Cursor Tracking',
    description: 'Gradient follows mouse position'
  },
  {
    value: 'slow-drift',
    label: 'Slow Drift',
    description: 'Subtle animated gradient drift'
  },
...
export const HEADER_VARIANTS: VariantOption<HeaderVariant>[] = [
  {
    value: 'default',
    label: 'Default Bar',
    description: 'Standard full-width navigation'
  },
  {
    value: 'simple',
    label: 'Simple Pill',
...
export const COLOR_ACCENT_VARIANTS: VariantOption<ColorAccentVariant>[] = [
  {
    value: 'full',
    label: 'Full Color',
    description: 'Purple accent on all interactive elements'
  },
  {
    value: 'subtle',
    label: 'Subtle',
    description: 'Purple accent only on primary buttons'
  },
  {
    value: 'minimal',
    label: 'Minimal',
    description: 'Mostly monochrome, minimal purple'
  }
];
...
export const HERO_VARIANTS: VariantOption<HeroVariant>[] = [
  {
    value: 'marketing',
    label: 'Marketing',
    description: 'Centered hero with pills and tabs'
  },
  {
    value: 'split',
    label: 'Split Layout',
    description: 'Content left, visual right - denser info'
  },
  {
    value: 'pricing',
    label: 'Pricing',
    description: 'Simple centered hero for pricing'
  },
  {
    value: 'story',
    label: 'Story',
    description: 'Text-heavy hero for about pages'
  },
...
export const LOGOS_VARIANTS: VariantOption<LogosVariant>[] = [
  { value: 'default', label: 'Default', description: 'Standard logo strip' },
  {
    value: 'linear',
    label: 'Linear Style',
    description: 'Blur-on-hover with customer story links'
  },
  {
    value: 'marquee',
    label: 'Marquee',
    description: 'Scrolling logos with pause on hover'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const FEATURES_VARIANTS: VariantOption<FeaturesVariant>[] = [
  {
    value: 'bento-tabs',
    label: 'Bento Tabs',
    description: 'Tabbed bento grids with smart hover (recommended)'
  },
  {
    value: 'solution',
    label: 'Solution Bento',
    description: 'Complex bento grid layout'
  },
  {
    value: 'tabbed',
    label: 'Tabbed Features',
    description: 'Attio-style tab-switching feature showcase'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const STATS_VARIANTS: VariantOption<StatsVariant>[] = [
  { value: 'default', label: 'Default', description: '4-column number ticker' },
  {
    value: 'orbital',
    label: 'Orbital',
    description: 'Animated cards with orbital rings and counters'
  },
  {
    value: 'timeline',
    label: 'Timeline',
...
export const TESTIMONIALS_VARIANTS: VariantOption<TestimonialsVariant>[] = [
  {
    value: 'default',
    label: 'Marquee',
    description: 'Infinite scrolling reviews'
  },
  {
    value: 'editorial',
    label: 'Editorial',
    description: 'Featured quote with case study cards'
  },
  { value: 'team', label: 'Team', description: 'Team member photos' },
  {
    value: 'clean',
    label: 'Clean',
    description: 'Minimal click-through testimonials with magnetic cursor'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const FAQ_VARIANTS: VariantOption<FaqVariant>[] = [
  { value: 'default', label: 'General', description: 'Standard accordion' },
  {
    value: 'cards',
    label: 'Cards',
    description: 'Animated card-based FAQ with categories'
  },
  {
    value: 'pricing',
    label: 'Pricing',
    description: 'Pricing specific questions'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const CTA_VARIANTS: VariantOption<CtaVariant>[] = [
  ...
  },
  {
    value: 'beam',
    label: 'Beam',
    description: 'Magnetic buttons with beam animations'
  },
...
export const BLOG_VARIANTS: VariantOption<BlogVariant>[] = [
  ...
  },
  {
    value: 'featured',
    label: 'Featured',
    description: 'Featured post with smaller grid'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const SDK_VARIANTS: VariantOption<SdkVariant>[] = [
  {
    value: 'default',
    label: 'SDK Code',
    description: 'Language-tabbed code snippets'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const ROLES_VARIANTS: VariantOption<RolesVariant>[] = [
  {
    value: 'cards',
    label: 'Cards Grid',
    description: '3-column cards with icons and images'
  },
  {
    value: 'bento',
    label: 'Bento Layout',
    description: 'Featured card with compact secondary cards'
  },
  {
    value: 'stacked',
    label: 'Stacked Cards',
    description: 'Full-width alternating horizontal layouts'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const FOOTER_VARIANTS: VariantOption<FooterVariant>[] = [
  ...
  },
  {
    value: 'flickering',
    label: 'Flickering',
    description: 'Footer with animated flickering grid'
  },
...
export const CUSTOMIZATION_VARIANTS: VariantOption<CustomizationVariant>[] = [
  ...
  },
  {
    value: 'expandable',
    label: 'Expandable',
    description: 'Accordion-style list with sticky header'
  },
  { value: 'off', label: 'Off', description: 'Hide this section' }
];
...
export const PAYWALL_BUILDER_FEATURES_VARIANTS: VariantOption<PaywallBuilderFeaturesVariant>[] =
  [
    ...
    },
    {
      value: 'bento',
      label: 'Bento',
      description: 'Asymmetric bento with spotlight effects'
    },
    {
      value: 'tabs',
      label: 'Tabs',
      description: 'Category-filtered tabbed view'
    },
    { value: 'off', label: 'Off', description: 'Hide this section' }
  ];
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of A/B testing features'
    },
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of onboarding features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'tabs',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of autopilot features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'tabs',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of LTV analytics features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'tabs',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of refund saver features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'tabs',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of marketer features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'tabs',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of app owner features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'tabs',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of developer features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'accordion',
  ...
  [
    {
      value: 'grid',
      label: 'Grid',
      description: '2-column grid of indie dev features'
    },
    { value: 'bento', label: 'Bento', description: 'Asymmetric bento layout' },
    {
      value: 'timeline',
      label: 'Timeline',
      description: 'Timeline-style feature progression'
    },
    { value: 'off', label: 'Off', description: 'Hide this section' }
  ];
...
export const HERO_LINES_VARIANTS: VariantOption<HeroLinesVariant>[] = [
  {
    value: 'above',
    label: 'Above Content',
    description: 'Dashed lines appear above hero content'
  },
  {
    value: 'below',
    label: 'Below Content',
    description: 'Dashed lines hidden behind hero content'
  }
];
...
export const IMAGE_SET_VARIANTS: VariantOption<ImageSetVariant>[] = [
  {
    value: 'set1',
    label: 'White Grid',
    description: 'White background with diagonal grid lines'
  },
  {
    value: 'set2',
    label: 'Monochrome',
    description: 'Strict monochrome with thin purple accents'
  },
  {
    value: 'set3',
    label: 'Warm Gray',
    description: 'Warm gray gradient with purple highlights'
  }
];
...
export function DebugProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    try {
      ...
      const globalParsed = globalStored
        ? (JSON.parse(globalStored) as Partial<DebugState>)
        : {};

      // Load page-specific settings
      const pageKey = getPageStorageKey(pathname);
      const pageStored = localStorage.getItem(pageKey);
      const pageParsed = pageStored
        ? (JSON.parse(pageStored) as Partial<DebugState>)
        : {};
  ...
  useEffect(() => {
    ...
    const radius =
      state.cornerRadiusVariant === 'round'
        ? '1rem'
        : state.cornerRadiusVariant === 'sharp'
          ? '0'
          : '0.5rem';
    root.style.setProperty('--radius', radius);
  }, [state.cornerRadiusVariant, isHydrated]);

  const setColorAccentVariant = useCallback(
    (variant: ColorAccentVariant) =>
      setState((prev) => ({ ...prev, colorAccentVariant: variant })),
    []
  );
  const setGridVariant = useCallback(
    (variant: GridVariant) =>
  ...
  const setDashedThicknessVariant = useCallback(
    (variant: GridThicknessVariant) =>
      setState((prev) => ({ ...prev, dashedThicknessVariant: variant })),
    []
  );
  const setGridColorVariant = useCallback(
    (variant: GridColorVariant) =>
      setState((prev) => ({ ...prev, gridColorVariant: variant })),
    []
  );
  const setGridOpacityVariant = useCallback(
    (variant: GridOpacityVariant) =>
      setState((prev) => ({ ...prev, gridOpacityVariant: variant })),
    []
  );
  const setGridZIndexVariant = useCallback(
    (variant: GridZIndexVariant) =>
      setState((prev) => ({ ...prev, gridZIndexVariant: variant })),
    []
  );
  const setHeaderVariant = useCallback(
    (variant: HeaderVariant) =>
      setState((prev) => ({ ...prev, headerVariant: variant })),
    []
  );
  const setHeroVariant = useCallback(
    (variant: HeroVariant) =>
      setState((prev) => ({ ...prev, heroVariant: variant })),
    []
  );
  const setLogosVariant = useCallback(
    (variant: LogosVariant) =>
      setState((prev) => ({ ...prev, logosVariant: variant })),
    []
  );
  const setFeaturesVariant = useCallback(
    (variant: FeaturesVariant) =>
      setState((prev) => ({ ...prev, featuresVariant: variant })),
    []
  );
  const setStatsVariant = useCallback(
    (variant: StatsVariant) =>
      setState((prev) => ({ ...prev, statsVariant: variant })),
    []
  );
  const setTestimonialsVariant = useCallback(
    (variant: TestimonialsVariant) =>
      setState((prev) => ({ ...prev, testimonialsVariant: variant })),
    []
  );
  const setFaqVariant = useCallback(
    (variant: FaqVariant) =>
      setState((prev) => ({ ...prev, faqVariant: variant })),
    []
  );
  const setCtaVariant = useCallback(
    (variant: CtaVariant) =>
      setState((prev) => ({ ...prev, ctaVariant: variant })),
    []
  );
  const setBlogVariant = useCallback(
    (variant: BlogVariant) =>
      setState((prev) => ({ ...prev, blogVariant: variant })),
    []
  );
  const setSdkVariant = useCallback(
    (variant: SdkVariant) =>
      setState((prev) => ({ ...prev, sdkVariant: variant })),
    []
  );
  const setRolesVariant = useCallback(
    (variant: RolesVariant) =>
      setState((prev) => ({ ...prev, rolesVariant: variant })),
    []
  );
  const setFooterVariant = useCallback(
    (variant: FooterVariant) =>
      setState((prev) => ({ ...prev, footerVariant: variant })),
    []
  );
  const setCustomizationVariant = useCallback(
    (variant: CustomizationVariant) =>
      setState((prev) => ({ ...prev, customizationVariant: variant })),
    []
  );
  const setPaywallBuilderFeaturesVariant = useCallback(
    (variant: PaywallBuilderFeaturesVariant) =>
      setState((prev) => ({ ...prev, paywallBuilderFeaturesVariant: variant })),
    []
  );
  const setAbTestingFeaturesVariant = useCallback(
    (variant: ABTestingFeaturesVariant) =>
      setState((prev) => ({ ...prev, abTestingFeaturesVariant: variant })),
    []
  );
  const setOnboardingBuilderFeaturesVariant = useCallback(
    (variant: OnboardingBuilderFeaturesVariant) =>
      setState((prev) => ({
        ...prev,
        onboardingBuilderFeaturesVariant: variant
      })),
    []
  );
  const setAutopilotFeaturesVariant = useCallback(
    (variant: AutopilotFeaturesVariant) =>
      setState((prev) => ({ ...prev, autopilotFeaturesVariant: variant })),
    []
  );
  const setLtvAnalyticsFeaturesVariant = useCallback(
    (variant: LTVAnalyticsFeaturesVariant) =>
      setState((prev) => ({ ...prev, ltvAnalyticsFeaturesVariant: variant })),
    []
  );
  const setRefundSaverFeaturesVariant = useCallback(
    (variant: RefundSaverFeaturesVariant) =>
      setState((prev) => ({ ...prev, refundSaverFeaturesVariant: variant })),
    []
  );
  const setForMarketersFeaturesVariant = useCallback(
    (variant: ForMarketersFeaturesVariant) =>
      setState((prev) => ({ ...prev, forMarketersFeaturesVariant: variant })),
    []
  );
  const setForAppOwnersFeaturesVariant = useCallback(
    (variant: ForAppOwnersFeaturesVariant) =>
      setState((prev) => ({ ...prev, forAppOwnersFeaturesVariant: variant })),
    []
  );
  const setForDevelopersFeaturesVariant = useCallback(
    (variant: ForDevelopersFeaturesVariant) =>
      setState((prev) => ({ ...prev, forDevelopersFeaturesVariant: variant })),
    []
  );
  const setForIndieFeaturesVariant = useCallback(
    (variant: ForIndieFeaturesVariant) =>
      setState((prev) => ({ ...prev, forIndieFeaturesVariant: variant })),
    []
  );
  const setHeroLinesVariant = useCallback(
    (variant: HeroLinesVariant) =>
      setState((prev) => ({ ...prev, heroLinesVariant: variant })),
    []
  );
  const setImageSetVariant = useCallback(
    (variant: ImageSetVariant) =>
...
export function useColorAccentVariant() {
  return (
    useContext(DebugContext)?.colorAccentVariant ??
    defaultState.colorAccentVariant
  );
}
export function useGridVariant() {
  return useContext(DebugContext)?.gridVariant ?? defaultState.gridVariant;
}
export function useCornerRadiusVariant() {
  return (
...
export function useDashedThicknessVariant() {
  return (
    useContext(DebugContext)?.dashedThicknessVariant ??
    defaultState.dashedThicknessVariant
  );
}
export function useGridColorVariant() {
  return (
    useContext(DebugContext)?.gridColorVariant ?? defaultState.gridColorVariant
  );
}
export function useGridOpacityVariant() {
  return (
    useContext(DebugContext)?.gridOpacityVariant ??
    defaultState.gridOpacityVariant
  );
}
export function useGridZIndexVariant() {
  return (
    useContext(DebugContext)?.gridZIndexVariant ??
    defaultState.gridZIndexVariant
  );
}
export function useHeaderVariant() {
  return useContext(DebugContext)?.headerVariant ?? defaultState.headerVariant;
}
export function useHeroVariant() {
  return useContext(DebugContext)?.heroVariant ?? defaultState.heroVariant;
}
export function useLogosVariant() {
  return useContext(DebugContext)?.logosVariant ?? defaultState.logosVariant;
}
export function useFeaturesVariant() {
  return (
    useContext(DebugContext)?.featuresVariant ?? defaultState.featuresVariant
  );
}
export function useStatsVariant() {
  return useContext(DebugContext)?.statsVariant ?? defaultState.statsVariant;
}
export function useTestimonialsVariant() {
  return (
    useContext(DebugContext)?.testimonialsVariant ??
    defaultState.testimonialsVariant
  );
}
export function useFaqVariant() {
  return useContext(DebugContext)?.faqVariant ?? defaultState.faqVariant;
}
export function useCtaVariant() {
  return useContext(DebugContext)?.ctaVariant ?? defaultState.ctaVariant;
}
export function useBlogVariant() {
  return useContext(DebugContext)?.blogVariant ?? defaultState.blogVariant;
}
export function useSdkVariant() {
  return useContext(DebugContext)?.sdkVariant ?? defaultState.sdkVariant;
}
export function useRolesVariant() {
  return useContext(DebugContext)?.rolesVariant ?? defaultState.rolesVariant;
}
export function useFooterVariant() {
  return useContext(DebugContext)?.footerVariant ?? defaultState.footerVariant;
}
export function useCustomizationVariant() {
  return (
    useContext(DebugContext)?.customizationVariant ??
    defaultState.customizationVariant
  );
}
export function usePaywallBuilderFeaturesVariant() {
  return (
    useContext(DebugContext)?.paywallBuilderFeaturesVariant ??
    defaultState.paywallBuilderFeaturesVariant
  );
}
export function useAbTestingFeaturesVariant() {
  return (
    useContext(DebugContext)?.abTestingFeaturesVariant ??
    defaultState.abTestingFeaturesVariant
  );
}
export function useOnboardingBuilderFeaturesVariant() {
  return (
    useContext(DebugContext)?.onboardingBuilderFeaturesVariant ??
    defaultState.onboardingBuilderFeaturesVariant
  );
}
export function useAutopilotFeaturesVariant() {
  return (
    useContext(DebugContext)?.autopilotFeaturesVariant ??
    defaultState.autopilotFeaturesVariant
  );
}
export function useLtvAnalyticsFeaturesVariant() {
  return (
    useContext(DebugContext)?.ltvAnalyticsFeaturesVariant ??
    defaultState.ltvAnalyticsFeaturesVariant
  );
}
export function useRefundSaverFeaturesVariant() {
  return (
    useContext(DebugContext)?.refundSaverFeaturesVariant ??
    defaultState.refundSaverFeaturesVariant
  );
}
export function useForMarketersFeaturesVariant() {
  return (
    useContext(DebugContext)?.forMarketersFeaturesVariant ??
    defaultState.forMarketersFeaturesVariant
  );
}
export function useForAppOwnersFeaturesVariant() {
  return (
    useContext(DebugContext)?.forAppOwnersFeaturesVariant ??
    defaultState.forAppOwnersFeaturesVariant
  );
}
export function useForDevelopersFeaturesVariant() {
  return (
    useContext(DebugContext)?.forDevelopersFeaturesVariant ??
    defaultState.forDevelopersFeaturesVariant
  );
}
export function useForIndieFeaturesVariant() {
  return (
    useContext(DebugContext)?.forIndieFeaturesVariant ??
    defaultState.forIndieFeaturesVariant
  );
}
export function useHeroLinesVariant() {
  return (
    useContext(DebugContext)?.heroLinesVariant ?? defaultState.heroLinesVariant
  );
}
...
export function useMonochromeMode() {
  return (
    useContext(DebugContext)?.monochromeMode ?? defaultState.monochromeMode
  );
}
