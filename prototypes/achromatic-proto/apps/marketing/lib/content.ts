...
export const content = {
  ...
  sdkPlatforms: [
    {
      name: 'iOS',
      src: '/images/sdks/swift.svg',
      color: 'bg-orange-50 border-orange-200'
    },
    {
      name: 'Android',
      src: '/images/sdks/kotlin.svg',
      color: 'bg-purple-50 border-purple-200'
    },
    {
      name: 'Flutter',
      src: '/images/sdks/flutter.svg',
      color: 'bg-sky-50 border-sky-200'
    },
    {
      name: 'React Native',
      src: '/images/sdks/react-native.svg',
      color: 'bg-cyan-50 border-cyan-200'
    },
    {
      name: 'Unity',
      src: '/images/sdks/unity.svg',
      color: 'bg-stone-800 border-stone-700'
    },
    {
      name: 'Stripe',
      src: '/images/sdks/stripe.svg',
...
export const paywallBuilderContent = {
  ...
  features: {
    ...
    description:
      'Everything you need to create, test, and optimize your paywalls. Pick one of our pre-made industry-tested templates or start from a blank page.',
    items: [
      {
        id: 'scale-paywall',
        icon: 'RefreshCw',
        ...
        description:
          'Re-create your paywall with the builder to be able to iterate faster: quickly adjust any of its elements, clone it, or launch an A/B test within minutes.',
        category: 'builder'
      },
      {
        ...
        description:
          "Changes to any element of the paywall made with the builder can be applied right away - there's no need to wait for the next app release.",
        category: 'builder'
      },
      {
        id: 'ab-testing',
        ...
        description:
          'Create a paywall pair with the builder and launch A/B tests with advanced analytics right away to find the most profitable variant.',
        category: 'testing'
      },
      {
        ...
        description:
          'Use the vertical layout structure and paywall preview to compose the very paywall you have in mind. Add multiple elements or keep it minimalistic.',
        category: 'builder'
      },
      {
        ...
        description:
          'Customize elements by adjusting color, size, alignment, opacity, and more. Choose among numerous popular fonts or upload custom ones.',
      ...
      },
      {
        ...
        description:
          "Boost your app's LTV by personalizing paywalls based on country or user properties. Localize multiple strings with a convenient table view.",
      ...
      },
      {
        ...
        description:
          'Paywalls autoscale to any phone screen size and can be previewed for numerous iOS and Android devices before publishing.',
        category: 'builder'
      },
      {
        ...
        description:
          'Adapty paywalls are built using native components, not webviews. They are platform-native, just like the rest of your app screens.',
  ...
  testimonials: [
    ...
    {
      quote:
        "Adapty's paywall builder allows us to test new pricing models and designs weekly. The ROI has been incredible.",
      author: 'Sarah Brown',
    ...
    {
      quote:
        "We increased our revenue by 30% just by testing different paywall layouts with Adapty. It's an essential tool for any subscription app.",
  ...
  faq: [
    {
      ...
      answer:
        'Yes, paywalls created with Adapty are natively rendered on both iOS and Android devices, ensuring high performance and a perfect look on any screen size.'
    },
    {
      question: 'Can I use my own design?',
      answer:
        "Absolutely. You can start with one of our high-converting templates or build your paywall from scratch to match your app's branding perfectly."
    },
    {
      question: 'Do I need to update my app to change prices?',
      answer:
        "No. With Adapty's Remote Config, you can change products, prices, and paywall designs instantly without submitting a new app version to the stores."
    },
    {
      question: 'Is it possible to A/B test paywalls?',
      answer:
        'Yes, seamless A/B testing is built right into the product. You can create multiple paywall variants and test them against each other to find the best performing one.'
    }
  ],
    ...
    items: [
      {
        ...
        details:
          'Test whether users convert better with a hard paywall (must subscribe to continue) or a soft paywall (can dismiss and access limited content). Our data shows the optimal approach varies by app category.'
      },
      {
        ...
        details:
          'Experiment with different value propositions, emotional triggers, and benefit lists. We have seen headline changes alone increase conversion by up to 30%.'
      },
      {
        id: 'cta-button',
        ...
        description:
          '"Subscribe", "Continue", or any other variant - see which one brings higher conversion.',
        details:
          'The right call-to-action can significantly impact your conversion. Test urgency-driven ("Start Now"), benefit-driven ("Unlock All Features"), or simple ("Continue") approaches.'
      },
      {
        id: 'background-color',
        icon: 'Palette',
        ...
        description:
          'Upload any background image or video, choose matching color schemes, and select between dark or light mode.',
        details:
          'Visual design affects trust and conversion. Support for gradients, images, videos, and animated backgrounds. Automatic color extraction for consistent theming.'
      },
      {
        id: 'extra-elements',
        icon: 'Sliders',
        ...
        description:
          'Experiment with money-making widgets like free trial toggle, carousel, and timer.',
        details:
          'Add conversion-boosting elements: countdown timers create urgency, carousels showcase features, toggles let users choose their plan. Mix and match for maximum impact.'
      },
      {
        ...
        description:
          'Test Weekly, 6 months, Annual, Monthly and other types of subscription along with prices to get the best result.',
        details:
          'Find the optimal price points and duration combinations. Test introductory offers, family plans, and bundled products. Our ML suggests winning combinations based on your user data.'
      }
    ]
  },
  ...
  cta: {
    ...
    description:
      'Join thousands of mobile apps using Adapty to increase their revenue.',
  ...
  relatedPages: [
    {
      ...
      description: 'Test paywall variants to find what converts best'
    },
    {
      title: 'Localization',
      href: '/paywall-localization',
      description: 'Localize paywalls for global audiences'
    },
    {
      title: 'Targeting',
      href: '/paywall-targeting',
      description: 'Show the right paywall to the right users'
    },
    {
      title: 'Adapty SDK',
      href: '/sdk',
      description: 'Native SDKs for iOS, Android, and more'
    }
  ],
...
export const PAYWALL_AB_TESTING_CONTENT = {
  hero: {
    ...
    description:
      'Test subscription pricing, durations, promotional offers, number of offers, layouts — all without coding. Use UI builder for changing paywall UI remotely.',
  ...
  features: {
    ...
    description:
      'Everything you need to optimize your app revenue through experimentation.',
    items: [
      {
        id: 'machine-learning',
        icon: 'BrainCircuit',
        ...
        description:
          'Adapty uses advanced ML models to predict test outcomes and automatically identify winning variants faster.'
      },
      {
        id: 'control',
        icon: 'ToggleRight',
        ...
        description:
          'Full control over your experiments. Run tests as long as needed and stop them instantly when you have a winner.'
      },
      {
        id: 'segments',
        icon: 'Users',
        ...
        description:
          'Run experiments for specific audiences based on country, device, or custom user attributes.'
      }
    ]
  },
