...
const COMPARISON_DATA = [
  ...
  },
  {
    feature: 'Conversions',
    adapty: '10 metrics',
    revenuecat: '3 metrics',
    qonversion: '2 metrics',
    superwall: '3 metrics'
  },
  {
    feature: 'Revenue and LTV prediction with ML',
    adapty: true,
    revenuecat: 'Beta-version',
    qonversion: false,
    superwall: false
  },
  {
    feature: 'Prediction of the winner in an A/B test',
    adapty: true,
    revenuecat: false,
    qonversion: false,
    superwall: false
  ...
  },
  {
    ...
    adapty: '70+ languages',
    revenuecat: 'Only through Offering metadata',
    qonversion: '18 languages',
    superwall: false
  },
  {
    feature: 'Targeted paywalls and A/B tests',
    adapty: true,
    revenuecat: 'Paywalls only',
    qonversion: 'Yes, but no targeting by attribution',
    superwall: 'Yes, but only by country and store'
  },
  {
    feature: 'No-code Paywall Builder',
    adapty: 'Yes, 100% custom paywalls',
    revenuecat: 'Yes, 5 templates',
    qonversion: true,
    superwall: true
  },
  {
    feature: 'Discount on Pro plans for startups',
    adapty: true,
    revenuecat: false,
    qonversion: false,
    superwall: false
                  ...
                  >
                    ...
                    >
                      ...
                      <CardContent className="p-6 relative z-10">
                        ...
                        <Link
                          href={role.link}
                          className="text-primary mt-4 inline-flex items-center text-sm font-medium group"
                        >
                          Learn more
                          <motion.span
                            animate={
