...
const REPORT_SECTIONS = [
  {
    ...
    description:
      'See where revenue comes from by region and plan to prioritize what converts best.'
  },
  {
    icon: BarChart3Icon,
    title: 'Subscription market breakdown',
    description:
      'Compare revenue share across regions and plan types to prioritize what converts where.'
  },
  {
    icon: TrendingUpIcon,
    title: 'Conversion benchmarks',
    description:
      "Spot funnel drop-offs by plan, price, and trial - and fix what's slowing users down."
  },
  {
    icon: UsersIcon,
    title: 'LTV & profitability',
    description:
      'Find the most profitable plans by region, price, and trial to monetize smarter.'
  },
  {
    icon: RefreshCwIcon,
    title: 'Retention and renewals',
    description:
      'Explore how trials and plan types impact retention - and focus on what drives renewals.'
  },
  {
    icon: ReceiptIcon,
    title: 'Refund trends',
    description:
      'Break down refund rates by price and plan to reduce churn before it spikes.'
  },
  {
    icon: TestTubesIcon,
    title: 'A/B experiments and paywalls',
    description:
      'Discover which paywalls convert best, what drives uplift, and how testing impacts revenue at scale.'
  }
];
  ...
  return (
    <GridSection className="relative overflow-hidden">
      ...
      <div className="container py-20 relative z-10">
        {/* Key stats */}
        <BlurFade delay={0.05}>
          <SiteHeading title="15,000+ apps' data, distilled into growth moves you can copy today" />
        </BlurFade>
        ...
        <div className="mt-20">
          <BlurFade delay={0.15}>
            <SiteHeading title="Designed to make every decision easier and faster" />
          </BlurFade>
        ...
        <div className="mt-20">
          <BlurFade delay={0.35}>
            <SiteHeading title="Key insights from A/B testing" />
            ...
            <Card className="inline-block max-w-2xl relative overflow-hidden">
              ...
              <CardContent className="p-8 relative">
                <h3 className="text-xl font-semibold mb-2">
                  Your next growth decision starts with better data
                </h3>
                <p className="text-muted-foreground mb-6">
                  For teams making pricing, paywall, and monetization decisions
                  today.
                </p>
                <motion.div
