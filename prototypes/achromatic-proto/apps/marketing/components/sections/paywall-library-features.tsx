        ...
        >
          ...
          <div className="relative z-10">
            ...
            <h3 className="text-xl font-semibold mb-2">
              Ready to build your own paywall?
            </h3>
            <p className="text-muted-foreground mb-6">
              Use Adapty's Paywall Builder to create beautiful, high-converting
              paywalls without coding. A/B test different designs and optimize
              for maximum revenue.
            </p>
            <Link
...
const FAQS = [
  {
    ...
    answer:
      "The Adapty Paywall Library is a comprehensive collection of over 10,000 mobile app paywalls. It's designed to help app developers and designers find inspiration and learn best practices for creating effective paywalls."
  },
  {
    question: 'How can I use the Paywall Library?',
    answer:
      "You can browse paywalls by category, search for specific apps, or explore top-grossing apps. Each paywall includes details about the app's revenue and subscription model to help you understand what works."
  },
  {
    question: 'Is the Paywall Library free to use?',
    answer:
      "Yes, the Paywall Library is completely free to browse. You can explore thousands of paywalls without any cost. To build and test your own paywalls, you can sign up for Adapty's free tier."
  },
  {
    question: 'How often is the library updated?',
    answer:
      'The library is updated regularly with new paywalls from the App Store and Google Play. We track changes to existing paywalls and add new apps as they implement in-app purchases.'
  },
  {
    question: 'Can I build similar paywalls with Adapty?',
    answer:
      "Yes! Adapty's Paywall Builder lets you create beautiful, high-converting paywalls without coding. You can use the library for inspiration and then build your own customized version."
  },
  {
    question: 'What makes a successful paywall?',
    answer:
      'Successful paywalls typically have clear value propositions, compelling visuals, well-structured pricing, and strong calls to action. The library helps you study what top apps are doing to maximize conversions.'
  }
];
