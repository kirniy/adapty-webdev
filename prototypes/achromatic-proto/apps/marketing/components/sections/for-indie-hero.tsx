...
import { ArrowRightIcon, RocketIcon, CreditCardIcon, ClockIcon, HeartIcon, SparklesIcon, CheckIcon, ZapIcon } from 'lucide-react';
          ...
          <BlurFade delay={0.2}>
            ...
            >
              <Card className={cn(
                ...
                isCardHovered ? "border-primary shadow-2xl shadow-primary/20" : "border-primary/30"
              )}>
                {/* Gradient background */}
