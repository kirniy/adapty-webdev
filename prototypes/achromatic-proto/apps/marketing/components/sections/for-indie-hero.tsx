...
const INDIE_TESTIMONIALS = [
  {
    quote: 'Adapty helped me go from side project to $10K MRR',
    author: 'Solo iOS dev'
  },
  { quote: 'Setup took 10 minutes, not days', author: 'Indie Android dev' },
  {
    quote: 'Finally, analytics I can actually understand',
...
function SplitHero() {
  const shouldReduceMotion = useReducedMotion();
  const [isHovered, setIsHovered] = React.useState<'start' | 'demo' | null>(
    null
  );
          ...
          <div className="flex flex-col gap-6">
            ...
            <BlurFade delay={0.15}>
              <p className="max-w-xl text-left text-base leading-relaxed text-muted-foreground sm:text-lg">
                Whether starting with a single app, working alone, or with a
                small bootstrapped team - we have got you covered. Focus on your
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <BlurFade delay={0.15}>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground sm:text-xl">
              Whether starting with a single app, working alone, or with a small
              bootstrapped team - we have got you covered. Focus on your
              product, not the infrastructure.
            </p>
          </BlurFade>
...
function StartupHero() {
  const shouldReduceMotion = useReducedMotion();
  const [isHovered, setIsHovered] = React.useState<'apply' | 'learn' | null>(
    null
  );
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-6">
            <BlurFade delay={0.05}>
              <Badge
                variant="outline"
                className="w-fit rounded-full px-4 py-1.5 border-primary/50 bg-primary/5"
              >
            ...
            <BlurFade delay={0.1}>
              <h1 className="text-left text-3xl font-bold leading-tight tracking-tight sm:text-4xl md:text-5xl lg:text-[52px] lg:leading-[1.1]">
                Get Adapty <span className="text-primary">free for 1 year</span>{' '}
                as a startup
              </h1>
            </BlurFade>
            ...
            <BlurFade delay={0.15}>
              <p className="max-w-xl text-left text-base leading-relaxed text-muted-foreground sm:text-lg">
                Just like you, we are a startup too. We know the pain of
                building with limited resources. That is why we have created a
                special program for early-stage companies.
              </p>
            </BlurFade>
...
// MAIN EXPORT
// =============================================================================
export const FOR_INDIE_HERO_VARIANTS = [
  'split',
  'centered',
  'startup'
] as const;
