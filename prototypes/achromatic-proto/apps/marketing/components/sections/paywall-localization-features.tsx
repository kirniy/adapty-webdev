  ...
  return (
    <div className="mt-6 h-[80px] rounded-lg bg-muted/30 border border-border/50 p-4 flex items-center justify-center gap-4">
      <div className="flex flex-col items-center gap-1">
        ...
        <div className="h-5 px-2 rounded bg-muted text-xs flex items-center">Hello</div>
      </div>
    ...
    <div className="mt-6 h-[80px] rounded-lg bg-muted/30 border border-border/50 p-3 font-mono text-[10px] overflow-hidden">
      ...
      <div className="space-y-0.5 text-muted-foreground">
        ...
        <motion.div
          ...
          className="pl-3"
        >
          <span className="text-primary">"en"</span>: {"{"} <span className="text-green-500">"cta"</span>: <span className="text-amber-500">"Subscribe"</span> {"}"}
        </motion.div>
        <motion.div
          animate={shouldReduceMotion ? {} : { opacity: [0.5, 1, 0.5] }}
          ...
          className="pl-3"
        >
          <span className="text-primary">"es"</span>: {"{"} <span className="text-green-500">"cta"</span>: <span className="text-amber-500">"Suscribir"</span> {"}"}
        </motion.div>
        <div>{'}'}</div>
      </div>
    </div>
...
const FEATURES = [
  {
    ...
    description: 'Add translations and preview the result within one dashboard for the paywalls made in the Paywall Builder.',
  ...
  },
  {
    ...
    description: 'Easily add new locales as separate JSONs and conveniently edit all the translations.',
    link: '/remote-config',
  ...
  },
  {
    ...
    description: 'Use AI to automatically translate your paywall content to any language with high accuracy.',
    link: '/paywall-builder',
