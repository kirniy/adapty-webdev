...
function AppsTrustMagic() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border bg-background/95 px-4 py-2 backdrop-blur-sm">
...
function SavingsBadgeMagic() {
  ...
  return (
    <div className="inline-flex items-center gap-2 rounded-full border bg-green-50 dark:bg-green-950/30 border-green-200 dark:border-green-900 px-4 py-2 ">
      ...
      <span className="text-xs text-muted-foreground">avg. cost savings</span>
    </div>
  );
}
      ...
      <div className="container space-y-12 py-20 relative z-10">
        ...
        >
          <div className="text-center text-sm text-muted-foreground max-w-2xl mx-auto">
            <p>
              All plans include unlimited paywalls, SDK integration, and
              real-time analytics. Need a custom solution?{' '}
              <Link
                href="/contact"
                className="text-primary transition-colors duration-150 ease-out hover:underline motion-reduce:transition-none"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <BlurFade delay={0.15}>
            <p className="mt-6 text-lg text-muted-foreground max-w-2xl mx-auto">
              Start free with up to $10K monthly tracked revenue. Pay only 0.6%
              of MTR as you grow.
            </p>
          </BlurFade>
