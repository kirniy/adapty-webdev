...
import { CheckIcon, CodeIcon, ZapIcon, ShieldIcon, RefreshCwIcon, TerminalIcon, BookOpenIcon } from 'lucide-react';
...
function SplitHero() {
 ...
 if (part.match(/^["']/)) return <span key={j} className="text-primary">{part}</span>;
