    ...
    >
      ...
      <Link
        ...
        className={cn(
          ...
          variant === 'default' &&
            'bg-foreground text-background hover:bg-foreground/90 hover:',
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-6">
            <BlurFade delay={0.05}>
              ...
              >
                ...
                <span className="relative z-10">
                  {paywallBuilderContent.hero.badge}
                </span>
              </Badge>
            </BlurFade>
            ...
            <BlurFade delay={0.25}>
              <div className="flex flex-col sm:flex-row items-start gap-4 pt-2">
                <HeroButton
                  href={paywallBuilderContent.hero.primaryCtaHref}
                  variant="default"
                >
                ...
                <HeroButton
                  href={paywallBuilderContent.hero.secondaryCtaHref}
                  variant="outline"
                  external
                >
          ...
          <BlurFade delay={0.2}>
            ...
            >
              ...
              <div
                className={cn(
                  'group relative w-full overflow-hidden rounded-xl border bg-background transition-all duration-300',
                  monochromeMode &&
              ...
              >
                ...
                <Image
                  ...
                  quality={100}
                  src={getImagePath(
                    '/assets/hero/light-feature1.webp',
                    imageSet
                  )}
                  width="1328"
                  height="727"
                ...
                <Image
                  ...
                  quality={100}
                  src={getImagePath(
                    '/assets/hero/dark-feature1.webp',
                    imageSet
                  )}
                  width="1328"
                  height="727"
                ...
                {CHECKLIST.map((item, index) => (
                  ...
                  >
                    <motion.div
                      ...
                      className="flex size-5 items-center justify-center rounded-full bg-primary/10 group-hover:bg-primary/20 transition-colors"
                    >
...
export function PaywallBuilderHero({
  variant = 'split'
