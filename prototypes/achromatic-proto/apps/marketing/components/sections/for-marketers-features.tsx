...
const FEATURES = [
  {
    ...
    description:
      'Find the optimal paywall with Adapty paywall A/B testing that requires no additional coding. Compare subscriptions, offers, free trials, copy, images, and more.',
  ...
  },
  {
    ...
    description:
      'Use our collection of highly customizable industry-proven paywall templates to change paywall UI and pricing quickly.',
  ...
  },
  {
    ...
    description:
      'Fine-tune your offers for different groups of users, like selling more expensive products to your power users while promoting a free trial for others.',
  ...
  },
  {
    ...
    description:
      "With machine learning, Adapty's LTV and revenue prediction will help you understand your profitability for a given cohort.",
    link: null,
    linkText: null,
    category: 'analytics'
  },
  {
    ...
    description:
      'Get real-time vital subscription and revenue analytics. Segment and filter audience, compare time periods, and track your sales funnel with cohort analysis.',
    link: null,
    linkText: null,
    category: 'analytics'
  },
  {
    ...
    description:
      "We know it's important to use other services to help you optimize your ad campaigns and user acquisition. Adapty makes it easy to push data to 3rd party services.",
    link: null,
    linkText: null,
  ...
  },
  {
    ...
    description:
      'Analyze your ASA performance right in the Adapty dashboard. Get revenue, LTV, and other core metrics on the keyword level.',
    link: null,
    linkText: null,
    category: 'analytics'
  },
  {
    ...
    description:
      'Trying a new traffic source or a country? Localize paywalls for the local audience right in the Adapty dashboard.',
      ...
      <div className="mt-4 flex gap-2 justify-center">
        {['A', 'B', 'C'].map((v, i) => (
          <div
            key={v}
            className={cn(
              'w-10 h-14 rounded border flex items-center justify-center text-xs font-bold',
              i === 0 ? 'bg-primary/20 border-primary' : 'bg-muted/50'
            )}
          >
            {v}
          </div>
...
function BuilderMagic() {
  ...
  return (
    <div className="mt-4 flex flex-col gap-1 items-center">
      <motion.div
        animate={{
          scale: activeBlock === 0 ? 1.1 : 1,
          borderColor: activeBlock === 0 ? 'hsl(var(--primary))' : 'transparent'
        }}
        className="w-24 h-3 bg-muted rounded border-2"
      />
      <motion.div
        animate={{
          scale: activeBlock === 1 ? 1.1 : 1,
          borderColor: activeBlock === 1 ? 'hsl(var(--primary))' : 'transparent'
        }}
        className="w-20 h-2 bg-muted/50 rounded border-2"
      />
      <motion.div
        animate={{
          scale: activeBlock === 2 ? 1.1 : 1,
          borderColor: activeBlock === 2 ? 'hsl(var(--primary))' : 'transparent'
        }}
        className="w-16 h-6 bg-primary/20 rounded mt-1 border-2"
      />
      <motion.div
        animate={{
          scale: activeBlock === 3 ? 1.1 : 1,
          borderColor: activeBlock === 3 ? 'hsl(var(--primary))' : 'transparent'
        }}
  ...
  if (shouldReduceMotion) {
    return (
      <div className="mt-4 flex justify-center gap-3">
        ...
        <div className="h-6 px-2 rounded bg-primary/20 text-[10px] flex items-center font-medium">
          Premium
        </div>
      </div>
    );
...
export const FOR_MARKETERS_FEATURES_VARIANTS = [
  'grid',
  'bento',
  'tabs'
] as const;
...
function BentoFeatures(): React.JSX.Element {
  ...
  const getGridClass = (index: number) => {
    switch (index) {
      ...
      case 1:
        return 'md:row-span-2'; // Tall card
      default:
        return '';
    }
  };
                ...
                >
                  <div
                    className={cn(
                      ...
                      hoveredIndex === index && 'border-primary/30  ',
                      index === 0 &&
                        'bg-gradient-to-br from-primary/5 via-background/80 to-background/50 border-primary/20'
                    )}
                  >
                    <Spotlight
                      className="from-primary/20 via-primary/5 to-transparent"
                      size={isLarge ? 350 : 250}
                    />
                    ...
                    >
                      <div className="flex items-start justify-between mb-4">
                        ...
                        >
                          <feature.icon
                            className={index === 0 ? 'size-7' : 'size-5'}
                          />
                        </motion.div>
                      </div>
                      <h3
...
export function ForMarketersFeatures({
  variant = 'grid'
