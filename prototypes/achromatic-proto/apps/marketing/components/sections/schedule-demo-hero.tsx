              ...
              <Card className="py-8 relative overflow-hidden">
                ...
                <CardContent className="flex flex-col gap-5 px-6 lg:px-8">
                  ...
                  <p className="text-xs text-center text-muted-foreground">
                    ...
                    <Link
                      href="/terms-of-use"
                      className="underline hover:text-foreground transition-colors duration-150 ease-out motion-reduce:transition-none"
                    >
                      Terms of Use
                    </Link>{' '}
                    and{' '}
              ...
              <ul className="space-y-3">
                {DEMO_BENEFITS.map((benefit, index) => (
                  ...
                  >
                    ...
                    <span
                      className={`transition-colors duration-150 ${hoveredBenefit === index ? 'text-foreground' : 'text-muted-foreground'}`}
                    >
                      {benefit}
                    </span>
                  </motion.li>
