...
const COMPARISON_ITEMS = [
  ...
  },
  {
    ...
    adapty: {
      status: 'check',
      description: 'Yes, by payments and by days after install'
    },
  ...
  },
  {
    ...
    competitor: {
      status: 'partial',
      description: 'Yes, only by country and store'
    }
  },
  {
          ...
          <div className="py-16">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-muted-foreground mb-8">
                Many of our customers are former Qonversion users. You're sure
