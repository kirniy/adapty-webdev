...
function PlatformFeaturesMagic() {
  ...
  const totalFeatures = FEATURE_TABS.reduce(
    (acc, tab) => acc + tab.features.length,
    0
  );
...
const FEATURE_TABS: FeatureTab[] = [
  {
    ...
    description:
      'Create conversion-optimized paywalls without engineering. Update instantly, no app releases needed.',
    ...
    features: [
      ...
      },
      {
        ...
        description: '50+ languages with custom overrides',
        icon: GlobeIcon,
        stat: '50+ languages'
      },
      {
        ...
        description: 'Change paywalls without app store review',
        icon: ZapIcon,
        stat: '<1s load'
      },
      {
        ...
        description: 'Fully native on iOS and Android',
        icon: SmartphoneIcon,
        stat: '30% avg lift'
      }
    ],
  ...
  },
  {
    ...
    description:
      'Run experiments on paywalls, pricing, and offers. Know when results are statistically significant.',
    ...
    features: [
      {
        id: 'experiments',
        title: 'Multi-Variant Tests',
        description: 'Test unlimited variants with auto traffic allocation',
        icon: TargetIcon,
        stat: '+40% revenue'
      },
      {
        ...
        description: 'Bayesian analysis for faster insights',
        icon: TrendingUpIcon,
        stat: '95% confidence'
      },
      {
        ...
        description: 'Test on specific user segments',
        icon: UsersIcon,
        stat: '3x faster'
      },
      {
        ...
        description: 'Push winning variants instantly',
        icon: ZapIcon,
        stat: 'Instant'
      }
    ],
  ...
  },
  {
    ...
    description:
      'Real-time subscription analytics with LTV predictions, cohort analysis, and churn monitoring.',
    ...
    features: [
      {
        ...
        description: 'MRR, ARR, trials, conversions at a glance',
        icon: PieChartIcon,
        stat: '$2B+ tracked'
      },
      {
      ...
      },
      {
        ...
        description: 'Track retention by cohort over time',
        icon: LineChartIcon,
        stat: '50+ metrics'
      },
      {
        id: 'attribution',
        title: 'Attribution',
        description: 'Connect revenue to marketing channels',
        icon: TargetIcon,
        stat: 'Real-time'
      }
    ],
  ...
  },
  {
    ...
    description:
      'Battle-tested SDKs for all platforms with server-side receipt validation and automatic sync.',
    ...
    features: [
      {
        ...
        description: 'Secure receipt validation without exposing secrets',
        icon: ServerIcon,
        stat: '99.99% uptime'
      },
      {
        ...
        description: 'Works reliably with poor network',
      ...
      },
      {
        id: 'platforms',
        title: 'All Platforms',
        description: 'iOS, Android, React Native, Flutter, Unity',
        icon: SmartphoneIcon,
        stat: '5 platforms'
      },
      {
        id: 'sync',
        title: 'Auto Sync',
        description: 'Subscription status across devices',
        icon: ZapIcon,
        stat: 'Real-time'
      }
    ],
  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={
          shouldReduceMotion ? undefined : { scale: isHovered ? 1.05 : 1 }
        }
