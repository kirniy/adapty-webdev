...
const FEATURE_TABS = [
  {
    ...
    description:
      'Create and deploy conversion-optimized paywalls without writing code or releasing app updates.',
    features: [
      {
        icon: PaletteIcon,
        title: 'No-Code Builder',
        description: 'Drag-and-drop paywall designer with real-time preview'
      },
      {
        icon: GlobeIcon,
        title: 'Localization',
        description:
          'Automatic translation to 50+ languages with custom overrides'
      },
      {
        icon: ZapIcon,
        title: 'Instant Updates',
        description: 'Change paywalls instantly without app store review'
      },
      {
        icon: SmartphoneIcon,
        title: 'Native Experience',
        description: 'Fully native paywalls on iOS and Android'
      }
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      'Run experiments on paywalls, pricing, and messaging to find what converts best for your audience.',
    features: [
      {
        icon: TargetIcon,
        title: 'Statistical Significance',
        description:
          'Know when results are ready with automated significance detection'
      },
      {
        icon: UsersIcon,
        title: 'Audience Targeting',
        description:
          'Test on specific user segments based on behavior or attributes'
      },
      {
        icon: TrendingUpIcon,
        title: 'Bayesian Analysis',
        description:
          'Get actionable insights faster with Bayesian statistical methods'
      },
      {
        icon: ZapIcon,
        title: 'Instant Rollout',
        description: 'Push winning variants to 100% of users with one click'
      }
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      'Real-time subscription analytics, LTV predictions, and cohort analysis to optimize your monetization strategy.',
    features: [
      {
        icon: PieChartIcon,
        title: 'Revenue Dashboard',
        description: 'MRR, ARR, trials, conversions, and churn at a glance'
      },
      {
        icon: TrendingUpIcon,
        title: 'LTV Predictions',
        description:
          'AI-powered lifetime value forecasting for better decisions'
      },
      {
        icon: UsersIcon,
        title: 'Cohort Analysis',
        description: 'Track retention and revenue by user cohort over time'
      },
      {
        icon: TargetIcon,
        title: 'Attribution',
        description: 'Connect revenue to marketing channels and campaigns'
      }
    ],
    stats: [
  ...
  },
  {
    ...
    description:
      'Battle-tested SDKs for all major platforms with server-side receipt validation and automatic subscription sync.',
    features: [
      {
        icon: ServerIcon,
        title: 'Server-Side Validation',
        description: 'Secure receipt validation without exposing shared secrets'
      },
      {
        icon: ShieldCheckIcon,
        title: 'Offline Support',
        description: 'Works reliably even with poor network conditions'
      },
      {
        icon: SmartphoneIcon,
        title: 'Cross-Platform',
        description: 'iOS, Android, React Native, Flutter, and Unity SDKs'
      },
      {
        icon: ZapIcon,
        title: 'Automatic Sync',
        description: 'Subscription status synced automatically across devices'
      }
    ],
    stats: [
...
function FeatureCard({
  ...
  feature: (typeof FEATURE_TABS)[0]['features'][0];
  index: number;
}) {
  const shouldReduceMotion = useReducedMotion();
      ...
      <div className="container py-16 lg:py-24 relative z-10">
        ...
        <BlurFade className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg text-muted-foreground">
            From no-code paywall design to AI-powered analytics, Adapty gives
            you the complete toolkit for subscription success.
          </p>
          <div className="mt-4">
