...
const COMPARISON_DATA: FeatureCategory[] = [
  {
    ...
    features: [
      {
        name: 'Purchase SDKs for all platforms',
        free: true,
        pro: true,
        proPlus: true,
        enterprise: true
      ...
      {
        name: 'Subscription events webhooks',
        free: true,
        pro: true,
        proPlus: true,
        enterprise: true
...
function FeaturesCountMagic() {
  ...
  const totalFeatures = COMPARISON_DATA.reduce(
    ...
    return (
      <div className="flex items-center justify-center">
        <motion.div
          ...
          whileInView={
            shouldReduceMotion ? { scale: 1 } : { scale: 1, opacity: 1 }
          }
          viewport={{ once: true }}
                    ...
                    >
                      ...
                      {tier.id === 'pro' && (
                        <>
                          <Badge
                            variant="secondary"
                            className="ml-2 text-[10px] h-5 px-1.5 font-normal text-primary/80 bg-primary/10 hover:bg-primary/20"
                          >
                            Popular
                          </Badge>
