  ...
  return (
    <div className="mt-6 h-[80px] rounded-lg bg-muted/30 border border-border/50 p-4 flex items-center justify-center gap-3">
      ...
      <motion.div
        ...
        transition={{ duration: 1.5, repeat: Infinity }}
        className="bg-primary/10 text-primary text-[9px] px-2 py-0.5 rounded-full border border-primary/30"
      >
        +24%
      </motion.div>
    </div>
            ...
            <div className="relative overflow-hidden rounded-2xl border bg-gradient-to-br from-primary/5 to-primary/10 p-8 md:p-12">
              ...
              <div className="relative z-10">
                ...
                <blockquote className="text-lg italic text-muted-foreground">
                  ...
                  Thanks to its convenient user segmentation, we managed to
                  target paywalls and A/B tests for specific regions and user
                  cohorts, which resulted in steady MoM growth in separate
                  markets."
                </blockquote>
                <div className="mt-6">
