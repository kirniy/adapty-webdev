...
import { ActivityIcon, InfoIcon, TrendingUpIcon } from 'lucide-react';
...
const STATS = [
  {
    ...
    decimalPlaces: 0,
    detail:
      'Processing half a billion subscription events monthly with 99.99% uptime',
    color: 'text-blue-500'
  },
  {
    value: 1.4,
...
export const FOR_MARKETERS_STATS_VARIANTS = [
  'cards',
  'inline',
  'graph'
] as const;
      ...
      <div className="container py-16 lg:py-20 relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
          {STATS.map((stat, index) => (
            <BlurFade
              key={index}
              delay={shouldReduceMotion ? 0 : 0.05 + index * 0.08}
            >
              <motion.div
                ...
                <AnimatePresence>
                  {showDetail === index && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: 10 }}
                      className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-64 p-3 rounded-lg bg-popover border text-xs text-left z-10"
                    >
      ...
      <div className="container py-16 lg:py-24 relative z-10">
        ...
        <BlurFade className="mb-12 text-center">
          <SiteHeading
            badge={
              <>
                <ActivityIcon className="size-4 mr-1" /> Live Metrics
              </>
            }
                ...
                >
                  ...
                  >
                    ...
                    <CardContent className="relative z-10 p-4">
                      ...
                      <motion.div
                        className={cn(
                          'text-2xl md:text-3xl font-bold mt-4 text-center',
                          stat.color
                        )}
                        animate={
                          shouldReduceMotion
...
export function ForMarketersStats({
  variant = 'cards'
