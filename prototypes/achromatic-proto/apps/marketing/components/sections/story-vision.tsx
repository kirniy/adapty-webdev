...
export function StoryVision(): React.JSX.Element {
  ...
  const [hoveredParagraph, setHoveredParagraph] = React.useState<number | null>(
    null
  );
              ...
              >
                ...
                >
                  ...
                  <CardContent className="p-8 relative z-10">
                    ...
                    >
                      "Subscription monetization shouldn't be a barrier - it
                      should be an accelerator for every app developer."
                    </motion.p>
                  </CardContent>
                </Card>
              </motion.div>
