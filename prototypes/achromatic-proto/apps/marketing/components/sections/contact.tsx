...
export function Contact(): React.JSX.Element {
  const shouldReduceMotion = useReducedMotion();
  const [hoveredContact, setHoveredContact] = React.useState<number | null>(
    null
  );
  ...
  return (
    <GridSection className="relative overflow-hidden">
      ...
      <div className="container space-y-16 py-20 relative z-10">
        ...
        <div className="lg:container lg:max-w-5xl">
          <div className="flex flex-col justify-between gap-10 lg:flex-row lg:gap-20">
            ...
            <div className="space-y-8 text-center lg:w-1/2 lg:text-left">
              ...
              <BlurFade delay={0.15}>
                <p className="text-muted-foreground lg:max-w-[80%]">
                  ...
                  team. We will get back to you within 48 hours.
                </p>
              </BlurFade>
            ...
            >
              ...
              >
                <Card className="relative mx-auto w-full max-w-lg overflow-hidden py-6 lg:py-10 border-primary/10">
                  <Spotlight
