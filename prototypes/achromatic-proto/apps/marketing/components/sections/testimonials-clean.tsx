...
} from '@workspace/ui/components/clean-testimonial';
...
const ADAPTY_TESTIMONIALS: TestimonialItem[] = [
  ...
  {
    quote:
      "We've been working with Adapty since 2021 and I couldn't be happier about it. They have the best analytics on the market and all the integrations you can think of. Definitely recommend Adapty.",
    author: 'Chris Bick',
...
export function TestimonialsClean(): React.JSX.Element {
  return (
    <GridSection className="relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24 relative z-10 flex flex-col items-center justify-center gap-8">
        <Spotlight
