        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <BlurFade delay={0.3}>
            <motion.div
              ...
              className={cn(
                "mt-12 mx-auto max-w-5xl overflow-hidden rounded-xl border bg-background shadow-2xl",
                monochromeMode && "grayscale hover:grayscale-0 transition-[filter] duration-500"
              )}
            >
              <Image
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <BlurFade delay={0.35}>
            <motion.div
              ...
              transition={{ delay: 0.2, duration: 0.4, ease: [0.32, 0.72, 0, 1] }}
              className={cn(
                "mt-10 mx-auto max-w-5xl overflow-hidden rounded-xl border bg-background shadow-2xl",
                monochromeMode && "grayscale hover:grayscale-0 transition-[filter] duration-500"
              )}
            >
              <Image
