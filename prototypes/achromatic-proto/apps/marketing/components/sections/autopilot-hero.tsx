...
function SplitHero() {
  ...
  const [isHovered, setIsHovered] = React.useState<'audit' | 'try' | null>(
    null
  );
          ...
          <BlurFade delay={0.3}>
            <div className="mt-10 mx-auto max-w-xl">
              <blockquote className="text-muted-foreground italic">
                "Autopilot suggested experiments we never would have thought of.
                Our MRR grew 30% in the first month."
              </blockquote>
...
export const AUTOPILOT_HERO_VARIANTS = [
  'split',
  'centered',
  'showcase'
] as const;
