...
function ConfigSliderMagic() {
  ...
  const sliders = [
    ...
    { label: 'Trial', value: 40, color: 'bg-primary' },
      ...
      {sliders.map((slider, i) => (
        ...
        >
          ...
          <div className="flex-1 h-2 bg-muted/80 rounded-full overflow-hidden relative">
            ...
            >
              <motion.div
                className="absolute right-0 top-1/2 -translate-y-1/2 w-3 h-3 bg-white rounded-full border-2 border-current"
...
function CloudSyncMagic() {
  const shouldReduceMotion = useReducedMotion();
  const [syncState, setSyncState] = React.useState<'syncing' | 'synced'>(
    'syncing'
  );
...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'Changes propagate instantly across all connected devices without requiring app updates or restarts.',
  ...
  },
  {
    ...
    description:
      'Deploy config changes to millions of users instantly with automatic rollback if issues are detected.',
            ...
            <div className="relative overflow-hidden rounded-3xl border bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 p-10 md:p-14">
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <blockquote className="text-xl md:text-2xl italic text-muted-foreground leading-relaxed">
                  "We like it that Adapty provides deep customization
                  possibilities for paywalls and A/B tests. For a long time
                  we've been using Remote config to change elements and localize
                  our paywalls in a matter of minutes without having to wait for
                  another app review."
                </blockquote>
                <div className="mt-8">
          ...
          <div className="mt-20 text-center">
            ...
            >
              <Link
                ...
                className="inline-flex items-center gap-3 px-10 py-5 rounded-2xl bg-primary text-primary-foreground font-semibold text-lg hover:bg-primary/90 transition-colors "
              >
