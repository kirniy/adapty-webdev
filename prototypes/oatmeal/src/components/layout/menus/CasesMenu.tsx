...
export function CasesMenu() {
  return (
    <div className="w-[640px] p-6">
      <h4 className="text-xs font-semibold text-olive-400 uppercase tracking-wider mb-4 px-3">
        Case Studies
      </h4>
        ...
        {CASE_STUDIES.map((caseStudy) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <span className="text-sm font-medium text-olive-900 group-hover:text-olive-700 block truncate">
                {caseStudy.name}
              </span>
              <span className="text-xs text-olive-500 block truncate">
      ...
      <div className="mt-4 pt-4 border-t border-olive-200">
        <Link
          href="/case-studies"
          className="text-sm font-medium text-adapty-500 hover:text-adapty-600 hover:underline px-3"
        >
